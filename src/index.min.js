...
Rewrapper:f,Encryptor:g}}var k;"object"===typeof exports?k=require("crypto").randomBytes:k=function(c){c=new Uint8Array(c);crypto.getRandomValues(c);return c};var n="Noise_NK_25519_ChaChaPoly_BLAKE2b";"function"===typeof define&&define.amd?define(["supercop.wasm","ed25519-to-x25519.wasm","aez.wasm","noise-c.wasm"],h):"object"===typeof exports?module.exports=h(require("supercop.wasm"),require("ed25519-to-x25519.wasm"),require("aez.wasm"),require("noise-c.wasm")):this.detox_crypto=h(this.supercop_wasm,
