/*
 0BSD
*/
(function(){function p(d){var f;for(f=d.length-1;0<=f;--f){var g=f;++d[g];if(0!==d[g])break}}function m(d,f,g,e){function h(a){null==a&&(a=null);if(!(this instanceof h))return new h(a);null===a&&(a=n(48));this.b=a;this.a=new Uint8Array(12)}function k(a,b){if(!(this instanceof k))return new k(a,b);a?(this.a=e.HandshakeState(q,e.constants.NOISE_ROLE_INITIATOR),this.a.Initialize(null,null,b)):(this.a=e.HandshakeState(q,e.constants.NOISE_ROLE_RESPONDER),this.a.Initialize(null,b))}h.prototype={get_key:function(){return this.b},
...
a)},decrypt:function(a){return this.b.DecryptWithAd(new Uint8Array(0),a)},destroy:function(){this.a&&this.a.free();this.c&&this.c.free();this.b&&this.b.free()}};Object.defineProperty(k.prototype,"constructor",{enumerable:!1,value:k});return{ready:function(a){function b(){--c;c||a()}var c=4;d.ready(b);f.ready(b);g.ready(b);e.ready(b)},create_keypair:function(a){null==a&&(a=null);a||(a=d.createSeed());var b=d.createKeyPair(a);return{seed:a,ed25519:{"public":b.publicKey,"private":b.secretKey},x25519:{"public":f.convert_public_key(b.publicKey),
