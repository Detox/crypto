...
e.constants.NOISE_ACTION_READ_MESSAGE&&this.a.ReadMessage(a),this.f())},f:function(){var a=this.a.GetAction();if(a===e.constants.NOISE_ACTION_SPLIT){a=this.a.Split();this.c=a[0];this.b=a[1];a=new Uint8Array(0);var b=new Uint8Array(32);this.i=this.c.EncryptWithAd(a,b);this.h=this.b.EncryptWithAd(a,b);delete this.a}else if(a===e.constants.NOISE_ACTION_FAILED)throw delete this.a,Error("Noise handshake failed");},get_rewrapper_keys:function(){return[this.i,this.h]},encrypt:function(a){return this.c.EncryptWithAd(new Uint8Array(0),
