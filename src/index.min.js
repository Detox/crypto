...
e.constants.NOISE_ACTION_READ_MESSAGE&&this.a.ReadMessage(a),this.f())},f:function(){if(this.a.GetAction()===e.constants.NOISE_ACTION_SPLIT){var a=this.a.Split();this.c=a[0];this.b=a[1];a=new Uint8Array(0);var b=new Uint8Array(32);this.i=this.c.EncryptWithAd(a,b);this.h=this.b.EncryptWithAd(a,b);delete this.a}else if(this.a.GetAction()===e.constants.NOISE_ACTION_FAILED)throw delete this.a,Error("Noise handshake failed");},get_rewrapper_keys:function(){return[this.i,this.h]},encrypt:function(a){return this.c.EncryptWithAd(new Uint8Array(0),
a)},decrypt:function(a){return this.b.DecryptWithAd(new Uint8Array(0),a)},destroy:function(){this.a&&this.a.g();this.c&&this.c.g();this.b&&this.b.g()}};Object.defineProperty(h.prototype,"constructor",{enumerable:!1,value:h});return{ready:function(a){function b(){--f;f||a()}var f=4;c.ready(b);d.ready(b);g.ready(b);e.ready(b)},create_keypair:function(a){!a&&(a=null);a||(a=c.createSeed());var b=c.createKeyPair(a);return{seed:a,ed25519:{"public":b.publicKey,"private":b.secretKey},x25519:{"public":d.convert_public_key(b.publicKey),
"private":d.convert_private_key(a)}}},convert_public_key:function(a){return d.convert_public_key(a)},sign:function(a,b,d){return c.sign(a,b,d)},verify:function(a,b,d){return c.verify(a,b,d)},Rewrapper:f,Encryptor:h}}var l;"object"===typeof exports?l=require("crypto").randomBytes:l=function(c){c=new Uint8Array(c);crypto.getRandomValues(c);return c};var n="Noise_NK_25519_ChaChaPoly_BLAKE2b";"function"===typeof define&&define.amd?define(["supercop.wasm","ed25519-to-x25519.wasm","aez.wasm","noise-c.wasm"],
k):"object"===typeof exports?module.exports=k(require("supercop.wasm"),require("ed25519-to-x25519.wasm"),require("aez.wasm"),require("noise-c.wasm")):this.detox_crypto=k(this.supercop_wasm,this.ed25519_to_x25519_wasm,this.aez_wasm,this.noise_c_wasm)}).call(this);